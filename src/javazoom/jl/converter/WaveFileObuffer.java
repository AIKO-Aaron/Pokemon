...
public class WaveFileObuffer extends Obuffer {
	 ...
	 * 
	 * @param freq
	 *            The sample frequency of the samples in the buffer.
	 * 
	 * @param fileName
	...
	public void write_buffer(int val) {
		 ...
		 * 
		 * //myBuffer[0] = (short)(((buffer[j]>>8)&0x000000FF) | ((buffer[j]<<8)&0x0000FF00)); //myBuffer[1] = (short) (((buffer[j+1]>>8)&0x000000FF) | ((buffer[j+1]<<8)&0x0000FF00)); myBuffer[0] = buffer[j]; myBuffer[1] = buffer[j+1]; rc = outWave.WriteData (myBuffer,2); }
		 */
