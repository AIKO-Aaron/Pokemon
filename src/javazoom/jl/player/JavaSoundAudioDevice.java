	...
	protected void createSource() throws JavaLayerException {
		...
		try {
			...
			if (line instanceof SourceDataLine) {
				...
				source.open(fmt);
				/*
				 * if (source.isControlSupported(FloatControl.Type.MASTER_GAIN)) { FloatControl c = (FloatControl)source.getControl(FloatControl.Type.MASTER_GAIN); c.setValue(c.getMaximum()); }
				 */
				source.start();
